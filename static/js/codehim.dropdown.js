...
(function ($) {
  $.fn.CodehimDropdown = function (options) {
    ...
    return this.each(function () {
      ...
      $(offCanvas).addClass(setting.skin); //OffCanvas Speed 

      var speed = setting.offCanvasSpeed; //assign values (in milliseconds) to speed 
      ...
      $(".dropdown-heading").click(function () {
        ...
        $(thisMenu).slideToggle(); //close other dropdowns if opened
      ...
      var offCanvasDirection = setting.offCanvasDirection; //Open Menu
      ...
      function responsive(menuItemsWidth) {
        ...
        var mainLink = $(".dropdown-items").children("li"); //getting the width of main items shown in the menubar
